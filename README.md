...
Easy to hard - Court of stars, Temple, Shadowmoon, Algethar, HoV, Ruby, Azure, Nokhud
...
*mostly well tuned, just healer balance is an issue*
...
*this has been a huge issue in recent testing. lots of hard lost keys to random bolder deaths on the most obscure floors*
https://www.twitch.tv/videos/1657825719?t=15h19m19s
...
# Algethar Academy
## General Tuning
skitterflys are still overtuned and are always skipped on fort/high keys unless they get fixed. all of the count is gotten at the end and we skip as much as possible.

## Skitterfly 
sting dmg still(overtuned, 1 shotting players if combo'd). could add a cast to the sting for counterplay or make them not target same person.

## Hungry Lashers 
have on death affixes and it is really bad when they are way less hp/abundant. bursting main crimminal.
...
## Bird boss
currently everyone is trying to avoid the 2nd goal cause of how unplayable it is to have winds + tornado + fire. might need to cut down on this a bit
...
*this needs help bad its basically invisible*

## Invoker
arcane missles don't do any damage/scale

# Halls of Valor
## General Tuning
Decently tuned. Most of the dungeons is fine now. Fenryr is rough unless everyone dodges the bleed.
...
*dont know if this is still an issue*

## Hyrja
Eye of the storm with thundering is extremely hard to see(blue on blue). This is gamechanging cause if someone gets hit while theres massive group damage out(especially if healer gets hit) it can be game over.
...
HUGE BUG: When boss dies while casting ragnarok, the shield will fade and kill people. https://www.twitch.tv/videos/1657825719?t=11h30m46s

## Odyn
Rune dot is a bit nasty and hard to deal with when everyone is spread.

# Azure Vault
## General feedback
The 75% movespeed on runback is great. Can make it so we get that buff after every boss to improve traversing the dungeon.
...
*1 attack is fine after nerf but when it stacks up it's too hard to survive. the whelps are the most notable problem when they spawn 3+ at once.*
...
*really important these are basically invisble https://www.twitch.tv/videos/1658896766?t=4h8m53s*
...
*i'm not a healer but i still feel this fights too much compared to any other fight in the game atm. also scales out of control in higher tyrannical*
...
*after doing this fight more it is definitely a problem and sucks really bad. especially hard when the fight goes longer*
...
*This part still holds true. Need less mobs required in this dungeon. Right now we need to clear almost the entire dungeon while skipping 2nd and last boss trash. Also timers just lot tighter than other dungeons even though its a 40 minute long dungeon.*
...
3) Nerf the add hp
*after playing more of this, this boss is absolutely a problem that scales out of control*

## Storm/2nd Boss area
Remove/rework the squall mechanic completely. Serves no purpose with specific CCs just causes unnecessary class/comp/cc friction. Current strat is to just bring a warlock to banish the squall or have a hunter trap+dk grip it out. 
*this mechanic has been nerfed but its still very unpleasant to have and play around. should just remove the squall mechanic. The other mechanics are fine enough to have*
...
*still really hard with the overlap unless people know exactly how to deal with the overlap and not get 1 shot*
...
*after playing more, the bolstering mechanic is still by far the biggest pain point and is impossible to deal with unless people hard focus down the guy. once he bolsters and does shatter soul, its a 1 shot. https://www.twitch.tv/videos/1658896766?t=3h2m37s* 

Guardian winds sometimes not kickable/bugged
https://clips.twitch.tv/StrangeInterestingBaboonEagleEye-nxY3UkXEjGq6p6EA
*still bugged*

HUGE BUG: Boss won't die and reset when one dies or something. https://www.twitch.tv/videos/1658896766?t=3h15m14s
...
The spear suck in mechanic on a random player will double tick and 1 shot often.
...
## First area
Boss bugs out sometimes and theres no telegraph on the beam. https://www.twitch.tv/videos/1658896766?t=5h39m58s
...
Sha's explosion can't be stunned anymore making them really hard to deal with on high fortified. Especially dangerous when combined with mistweaver's touch of karma.
...
*still extremely inconsistent. some abilities generate stacks automatically*

## Third Area

Infester frontal needs better visual/indicator of frontal. Hard for range players to notice when there are a lot of adds around it. Maybe only aim at the tank?

Legsweep visual needs rework like Shattered resolve rework.

## Liu
Waves are still inconsistent and really hard to do without the line cheese strat.
...
*just reduce the damage by a lot and make it not dispellable so it's not a free or too hard of a fight*

# Court of Stars
## General Feedback/Tuning
Still no point in the beginning RP.

Entire dungeon is too easy until the last boss. The difference is too big especially on tyrannical.
