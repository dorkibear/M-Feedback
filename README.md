...
mobs void slash pure magic dmg, high frequency and very high damage. Rough for a lot of tanks.

## Sadana Bloodfury
Might scale out of control with tyrannical + grievous. Lots of pulsing constant dmg

## Enslaver's 
start casting rending voidlash when CC'd for the first time. It will target random players and do infinite magic damage. Also doesn't seem to have a cd? Casts after lockout ends. Also very rough on tanks weak to magic damage.

## Nhallish
Void Blast you can reflect and it deletes the boss from existence. Kinda simple boss

## Plagued bats
Does insane disease magic damage. Stacks up to 5 times too. Can also be reflected for lots of damage.
